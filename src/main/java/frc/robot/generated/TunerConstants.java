...
public class TunerConstants {
    ...
    private static final SteerFeedbackType kSteerFeedbackType = SteerFeedbackType.RemoteCANcoder; //used .FusedCANCoder if remote doesn't work
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.105224609375);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.110595703125);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.455810546875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.177978515625);
